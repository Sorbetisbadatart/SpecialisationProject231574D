    ...
    public static class DSIOUtility
    {
        ...
        private static void SaveNodeToGraph(DSNode node, DSGraphSaveDataSO graphData)
        {
            ...
            DSNodeSaveData nodeData = new DSNodeSaveData()
            {
                ...
                // Initialize event data (to be populated from node)
                StartConditions = new List<DSConditionSaveData>(),
                OnDialogueStarted = new UnityEventSaveData(),
                OnDialogueEnded = new UnityEventSaveData(),
                OnDialogueChoiceSelected = new UnityEventSaveData()
            };
        ...
        private static void SaveNodeToScriptableObject(DSNode node, DSDialogueContainerSO dialogueContainer)
        {
            ...
            // Enhanced initialization with events
            dialogue.Initialize(
                node.DialogueName,
                node.Text,
            ...
            // TODO: Copy event data from node to dialogue SO
            // This would require storing event data in DSNode during editing
            // and then applying it here during save
