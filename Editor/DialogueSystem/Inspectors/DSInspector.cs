...
namespace DS.Inspectors
{
    ...
    /// <summary>
    /// Custom inspector for the DSDialogue MonoBehaviour component.
    /// Provides user-friendly dropdowns for selecting dialogues from containers.
    /// </summary>
    ...
    public class DSInspector : Editor
    {
        ...
        /// <summary>
        /// Draws the custom inspector interface with filtering and selection options.
        /// </summary>
        public override void OnInspectorGUI()
        {
            ...
            {
                // Handle grouped dialogues selection
            ...
            {
                // Handle ungrouped dialogues selection
        ...
        private void DrawDialogueGroupArea(DSDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            // Handle index tracking for dropdown persistence
        ...
        /// <summary>
        /// Displays a help message and stops further drawing when conditions aren't met.
        /// </summary>
        ...
        /// <summary>
        /// Maintains selection consistency when the list of available options changes.
        /// </summary>
